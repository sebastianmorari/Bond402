...
export function BondSandboxPage() {
    ...
    <div className="min-h-[100dvh] bg-background text-foreground pb-28">
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-10 lg:px-8">
        <div className="mb-6 max-w-3xl">
          <h2 className="text-3xl font-bold tracking-tight">Bond- &amp; Reputations-Sandbox</h2>
          <p className="mt-2 text-lg text-muted-foreground">
            Simulieren Sie Sicherheitsprüfung, Test-Bond und Reputation ohne echte Werte oder Transaktionen.
          </p>
        </div>
